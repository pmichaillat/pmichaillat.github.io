...
+ December 2025 - The [US recession indicator](#us-recession-indicator) is back above the recession threshold of 0.29pp. As a result, the [US recession probability](#us-recession-probability) is positive again, currently at about 8%.[^1]
...
+ [View recession indicator in full screen](/dashboard/recession_indicator.html)
    + [View underlying unemployment (Sahm) indicator in full screen](/dashboard/unemployment_indicator.html)
    + [View underlying vacancy indicator in full screen](/dashboard/vacancy_indicator.html)
...
The bottom line is firms behave in reality exactly as in the model. The fact that firms post several vacancies per position does not mean that vacancy data should be discounted. This behavior is what matching models predict.
...
The formula and evidence provide several insights:
...
+ Pascal Michaillat and Emmanuel Saez. 2024. "u* = √uv: The Full-Employment Rate of Unemployment in the United States." [*Brookings Papers on Economic Activity*](https://www.brookings.edu/articles/u-√uv-the-full-employment-rate-of-unemployment-in-the-united-states/) 55 (2): 323–390.
    ...
    + [View the paper](/13/)
+ Pascal Michaillat and Emmanuel Saez. 2025. "Has the Recession Started?" [*Oxford Bulletin of Economics and Statistics*](https://doi.org/10.1111/obes.12685) 87 (6): 1047–1058.
