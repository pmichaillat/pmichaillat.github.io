...
In March 2024 the recession indicator crossed the 0.29pp threshold, so the single-threshold Michez rule signaled a US recession. By June 2026, the indicator reached 0, and remained at 0 in July and August 2026. The NBER has not declared a recession in 2024–2026, and it seems unlikely that they will. Accordingly, the single-threshold Michez rule produced a false positive during the period.
...
The slowdown signaled by the dual-threshold Michez rule also appeared in product markets. [Real GDP](https://fred.stlouisfed.org/series/gdpc1) contracted for one quarter, in 2025:Q1. [Industrial production](https://fred.stlouisfed.org/series/INDPRO) contracted in 2023:Q4, 2024:Q1, 2024:Q3, and 2024:Q4, with a recovery in 2024:Q2 between those declines. Output therefore weakened in 2024–2025, when the recession probability given by the dual-threshold rule was elevated. The rule was therefore tracking a real slowdown, although it never became an NBER recession.

That false positive produced by the single-threshold Michez rule is useful information. It can be incorporated into the training of future recession classifiers: by discarding classifiers that would have called a recession in 2024–2026, while still requiring perfect detection of historical recessions. [Michaillat (2025)](https://pascalmichaillat.org/17/) develops that approach by selecting the fastest and most accurate recession classifiers among all those that do not produce false positives or negatives over the training period. A large number of candidates is generated by considering many thresholds and many ways to filter labor market data.
