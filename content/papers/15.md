...
aliases:
    ...
    - /tags/inefficiency/
tags: ["Beveridge curve", "business cycles", "economic slack", "FERU", "matching model", "monetary policy", "Phillips curve", "price rigidity", "unemployment gap", "wealth in the utility"]
...
##### Figure 9A: Response to a negative aggregate-demand shock

![Response to a negative aggregate-demand shock](/15b.png)

##### Figure 9B: Response to a negative aggregate-supply shock

![Response to a negative aggregate-supply shock](/15c.png)
