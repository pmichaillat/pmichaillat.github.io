...
description: "This paper builds the Michez rule, a method to detect US recessions from unemployment and vacancy data. The rule has signaled a recession since March 2024."
summary: "This paper develops the Michez rule, a method to detect US recessions using data on unemployment and job vacancies. In December 2024, the rule gives a recession probability of 27%; this recession risk was first detected in March 2024."
cover:
    image: "/16s.png"
...
Michaillat, Pascal, and Emmanuel Saez. 2025. "Has the Recession Started?" *Oxford Bulletin of Economics and Statistics*. Forthcoming.
