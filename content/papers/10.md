...
number = {52},
pages = {13228--13233},
doi = {https://doi.org/10.1073/pnas.1816454115}}
```
...
+ [Nontechnical summary](https://www.bitss.org/the-persistence-of-false-paradigms-in-low-power-sciences/)
+ [Working paper (2017)](https://www.nber.org/system/files/working_papers/w23523/w23523.pdf) – This version of the paper develops a theory of promotion based on evaluations by the already promoted. The already promoted show some favoritism toward candidates for promotion with similar beliefs, just as beetles are more prone to eat the eggs of other species. With such egg-eating bias, false beliefs may not be eliminated by the promotion system. In hierarchical organizations, egg-eating bias can result in the capture of the top of the organization by the wrong-minded.