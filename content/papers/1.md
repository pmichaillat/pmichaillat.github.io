...
##### Figure 1E: Job-rationing model in good times

![Job-rationing model in good times](/1a.png)

##### Figure 1F: Job-rationing model in bad times

![Job-rationing model in bad times](/1b.png)

##### Figure 5: Rationing and frictional unemployment in the job-rationing model calibrated to the United States, 1964–2009

![Rationing and frictional unemployment in the job-rationing model calibrated to the United States, 1964–2009](/1c.png)
...
+ [Nontechnical summary](https://cep.lse.ac.uk/pubs/download/cp365.pdf)
+ [PhD dissertation (2010)](https://escholarship.org/uc/item/7jr3m96r) – My PhD dissertation at UC Berkeley is the basis for this paper. Chapter 2 in particular provides intuition for the paper's results based on an urn-ball model of the labor market.