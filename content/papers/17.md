...
date: 2025-03-15
url: /17/
tags: ["anticipation-precision frontier", "backtesting", "job vacancies", "nowcasting", "recession classifier", "recession probability", "recession threshold", "recessions",  "unemployment"]
...
summary: "The paper develops a new method for detecting US recessions in real time. The method combines recession classifiers selected from the anticipation-precision frontier. Backtesting confirms that the method detects recessions in a timely and accurate manner."
cover:
    image: "/17s.png"
