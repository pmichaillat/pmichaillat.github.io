...
##### Figure 1: Expansionary monetary shock in the New Keynesian model with fairness

![Expansionary monetary shock in the New Keynesian model with fairness](/8a.png)

##### Figure 2: Positive technology shock in the New Keynesian model with fairness

![Positive technology shock in the New Keynesian model with fairness](/8b.png)
...
+ [Previous version (2019)](https://arxiv.org/pdf/1904.05656v2.pdf) – This version of the paper studies disclosure of costs by firms. With disclosure, the passthrough of costs into prices is asymmetric. Firms choose to disclose cost increases but refuse to disclose cost decreases. As a result, firms pass through cost increases completely into prices but only pass through cost decreases incompletely into prices. The paper also provides photographic evidence of such behavior: firms commonly post signs alerting customers that costs increased so prices must go up too.
