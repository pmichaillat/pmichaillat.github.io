...
aliases:
    ...
    - /tags/ui-extensions/
tags: ["Baily-Chetty formula", "business cycles", "fiscal policy", "job rationing", "matching model", "market tightness", "state dependence", "wage rigidity"]
...
##### Figure 8: Sensitivity of the optimal UI replacement rate

![Sensitivity of the optimal UI replacement rate](/5b.png)
